...
window.onload = function () {
    ...
    $("#txtContraseña").on("keyup", function () {
...
function GuardarUsuario() {
    ...
    var isNewUser = $("#txtId").val() === "0";

    // Solo validar la contraseña si es un nuevo usuario o si se ha ingresado una nueva contraseña
    if (isNewUser || varContraseña.length > 0) {
