        ...
        columnDefs: [
            // {"className": "text-center", "targets": "_all"},
            {
                ...
                render: function (data, type, full, meta) {
                    return `<button class="btn btn-primary juntos fa fa-pencil btn-xs" onclick="ObtenerDatosxEnviarSap(` + full.IdEnviarSap +`,'`+full.TablaOriginal+ `')"></button>`
            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    return full.Moneda
                        + '<input style="display:none" id="inputids' + meta.row + '" value=' + full.IdOPCH + '>'
                },
            },
...
function validarEnvio() {
    ...
    $.post("ValidarGrupoEnviado", { 'GrupoCreacion': GrupoVar }, function (data, status) {
...
function enviarSAP() {
    ...
    setTimeout(() => {
        ...
        let varSerieNC = $("#cboSerieNotaCredito").val()
        let varBorradorFirme = 1;
