...
namespace DAO
{
    ...
    {
        public List<MotivoTrasladoDTO> ObtenerMotivoTraslado(int IdSociedad, string BaseDatos, ref string mensaje_error)
        {
        ...
        public int UpdateInsertMotivoTraslado(MotivoTrasladoDTO oMotivoTrasladoDTO, string BaseDatos, ref string mensaje_error)
        {
        ...
        public List<MotivoTrasladoDTO> ObtenerDatosxID(int IdMotivoTraslado, string BaseDatos, ref string mensaje_error)
        {
            List<MotivoTrasladoDTO> lstMotivoTrasladoDTO = new List<MotivoTrasladoDTO>();
            using (SqlConnection cn = new Conexion().conectar(BaseDatos))
            {
        ...
        public int Delete(int IdMotivoTraslado, string BaseDatos, ref string mensaje_error)
        {
            TransactionOptions transactionOptions = default(TransactionOptions);
            transactionOptions.IsolationLevel = System.Transactions.IsolationLevel.ReadCommitted;
            transactionOptions.Timeout = TimeSpan.FromSeconds(60.0);
